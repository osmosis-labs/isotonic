...
fn adjust_market_id() {
    ...
    assert_eq!(30, suite.query_config().unwrap().lendex_market_id);
}
...
fn adjust_token_id() {
    ...
    assert_eq!(30, suite.query_config().unwrap().lendex_token_id);
}
